...
(assert (forall ((i@6@09 Int)) (!
  ...
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/quickselect/arrays_quickselect_rec.vpr@215@12@215@69-aux|)))
(assert (forall ((i@6@09 Int)) (!
  (=>
    (and (<= 0 i@6@09) (<= i@6@09 10))
    (=
      ...
      i@6@09))
  :pattern ((loc<Ref> a@1@09 i@6@09))
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/quickselect/arrays_quickselect_rec.vpr@215@12@215@69|)))
...
(push) ; 4
; [then-branch: 11 | 0 <= i@28@09 && i@28@09 <= 10 | live]
; [else-branch: 11 | !(0 <= i@28@09 && i@28@09 <= 10) | live]
(push) ; 5
; [then-branch: 11 | 0 <= i@28@09 && i@28@09 <= 10]
(assert (and (<= 0 i@28@09) (<= i@28@09 10)))
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@28@09 (Seq_length pw@19@09))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 11 | !(0 <= i@28@09 && i@28@09 <= 10)]
(assert (not (and (<= 0 i@28@09) (<= i@28@09 10))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (=>
  (and (<= 0 i@28@09) (<= i@28@09 10))
  (and
    (<= 0 i@28@09)
    (<= i@28@09 10)
    (or
...
(push) ; 4
; [then-branch: 15 | 0 <= i@29@09 && i@29@09 < j@30@09 && j@30@09 <= 10 | live]
; [else-branch: 15 | !(0 <= i@29@09 && i@29@09 < j@30@09 && j@30@09 <= 10) | live]
(push) ; 5
; [then-branch: 15 | 0 <= i@29@09 && i@29@09 < j@30@09 && j@30@09 <= 10]
(assert (and (<= 0 i@29@09) (and (< i@29@09 j@30@09) (<= j@30@09 10))))
; [eval] pw[i] != pw[j]
; [eval] pw[i]
(push) ; 6
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< j@30@09 (Seq_length pw@19@09))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 15 | !(0 <= i@29@09 && i@29@09 < j@30@09 && j@30@09 <= 10)]
(assert (not (and (<= 0 i@29@09) (and (< i@29@09 j@30@09) (<= j@30@09 10)))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (=>
  (and (<= 0 i@29@09) (and (< i@29@09 j@30@09) (<= j@30@09 10)))
  (and (<= 0 i@29@09) (< i@29@09 j@30@09) (<= j@30@09 10))))
; Joined path conditions
(assert (or
  (not (and (<= 0 i@29@09) (and (< i@29@09 j@30@09) (<= j@30@09 10))))
  (and (<= 0 i@29@09) (and (< i@29@09 j@30@09) (<= j@30@09 10)))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
...
(push) ; 4
; [then-branch: 17 | 0 <= i@31@09 && i@31@09 <= 10 | live]
; [else-branch: 17 | !(0 <= i@31@09 && i@31@09 <= 10) | live]
(push) ; 5
; [then-branch: 17 | 0 <= i@31@09 && i@31@09 <= 10]
(assert (and (<= 0 i@31@09) (<= i@31@09 10)))
...
; (get-info :all-statistics)
(push) ; 6
(assert (not (< i@31@09 (Seq_length pw@19@09))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 17 | !(0 <= i@31@09 && i@31@09 <= 10)]
(assert (not (and (<= 0 i@31@09) (<= i@31@09 10))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
(assert (forall ((r $Ref)) (!
...
; Joined path conditions
(assert (or
  (not (and (<= 0 i@31@09) (<= i@31@09 10)))
  (and (<= 0 i@31@09) (<= i@31@09 10))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
(assert (forall ((r $Ref)) (!
  (=>
