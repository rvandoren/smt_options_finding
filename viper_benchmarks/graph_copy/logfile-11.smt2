...
; ------------------------------------------------------------
; ---------- pop ----------
(declare-const s1@0@11 Set<Int>)
(declare-const s2@1@11 Set<Int>)
(declare-const i@2@11 Int)
(declare-const s1@3@11 Set<Int>)
(declare-const s2@4@11 Set<Int>)
(declare-const i@5@11 Int)
(set-option :timeout 0)
(push) ; 1
(declare-const $t@6@11 $Snap)
(assert (= $t@6@11 $Snap.unit))
; [eval] 0 < |s1|
; [eval] |s1|
(assert (< 0 (Set_card s1@3@11)))
...
(assert (= ($Snap.first $t@7@11) $Snap.unit))
; [eval] (i in s1)
(assert (Set_in i@5@11 s1@3@11))
(assert (= ($Snap.second $t@7@11) $Snap.unit))
; [eval] s2 == (s1 setminus Set(i))
; [eval] (s1 setminus Set(i))
; [eval] Set(i)
(assert (Set_equal s2@4@11 (Set_difference s1@3@11 (Set_singleton i@5@11))))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
