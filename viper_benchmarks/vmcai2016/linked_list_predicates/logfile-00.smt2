...
; [eval] this != end ==> 0 < |result| && result[0] == (unfolding acc(lseg(this, end), write) in this.data)
; [eval] this != end
(push) ; 2
(push) ; 3
(set-option :timeout 10)
...
(assert (not (= this@0@00 end@1@00)))
; [eval] 0 < |result| && result[0] == (unfolding acc(lseg(this, end), write) in this.data)
; [eval] 0 < |result|
; [eval] |result|
(push) ; 4
; [then-branch: 2 | !(0 < |result@2@00|) | live]
; [else-branch: 2 | 0 < |result@2@00| | live]
(push) ; 5
; [then-branch: 2 | !(0 < |result@2@00|)]
(assert (not (< 0 (Seq_length result@2@00))))
(pop) ; 5
(push) ; 5
; [else-branch: 2 | 0 < |result@2@00|]
(assert (< 0 (Seq_length result@2@00)))
  ...
  (and
    ...
    (=>
      ...
      (and
        ...
        (joined_unfolding@14@00 s@$ this@0@00 end@1@00))))))
(assert (or (< 0 (Seq_length result@2@00)) (not (< 0 (Seq_length result@2@00)))))
(pop) ; 3
(push) ; 3
      ...
      (and
        ...
        (=>
          ...
          (and
            ...
            (joined_unfolding@14@00 s@$ this@0@00 end@1@00)))))
    (or (< 0 (Seq_length result@2@00)) (not (< 0 (Seq_length result@2@00)))))))
; Joined path conditions
...
(assert (forall ((i@15@00 Int) (j@16@00 Int)) (!
  ...
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/vmcai2016/linked-list-predicates.vpr@25@12@25@95-aux|)))
(assert (forall ((i@15@00 Int) (j@16@00 Int)) (!
  (=>
    (and
      (<= 0 i@15@00)
  ...
  :pattern ((Seq_index result@2@00 i@15@00) (Seq_index result@2@00 j@16@00))
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/vmcai2016/linked-list-predicates.vpr@25@12@25@95|)))
(pop) ; 1
...
; [eval] |result|
(push) ; 4
; [then-branch: 17 | !(0 < |result@2@00|) | live]
; [else-branch: 17 | 0 < |result@2@00| | live]
(push) ; 5
; [then-branch: 17 | !(0 < |result@2@00|)]
(assert (not (< 0 (Seq_length result@2@00))))
(pop) ; 5
(push) ; 5
; [else-branch: 17 | 0 < |result@2@00|]
(assert (< 0 (Seq_length result@2@00)))
; [eval] result[0] == (unfolding acc(lseg(this, end), write) in this.data)
; [eval] result[0]
; [eval] (unfolding acc(lseg(this, end), write) in this.data)
...
(assert (forall ((i@28@00 Int) (j@29@00 Int)) (!
  ...
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/vmcai2016/linked-list-predicates.vpr@57@12@57@95-aux|)))
(assert (forall ((i@28@00 Int) (j@29@00 Int)) (!
  (=>
    (and
      (<= 0 i@28@00)
  ...
  :pattern ((Seq_index result@7@00 i@28@00) (Seq_index result@7@00 j@29@00))
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/vmcai2016/linked-list-predicates.vpr@57@12@57@95|)))
(pop) ; 1
