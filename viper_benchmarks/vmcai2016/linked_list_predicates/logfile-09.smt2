...
; ------------------------------------------------------------
; ---------- dequeue ----------
(declare-const this@0@09 $Ref)
(declare-const res@1@09 Int)
(declare-const this@2@09 $Ref)
(declare-const res@3@09 Int)
(set-option :timeout 0)
(push) ; 1
(declare-const $t@4@09 $Snap)
(assert (= $t@4@09 ($Snap.combine ($Snap.first $t@4@09) ($Snap.second $t@4@09))))
(assert (= ($Snap.second $t@4@09) $Snap.unit))
; [eval] 0 < length(this)
; [eval] length(this)
(push) ; 2
(assert (length%precondition ($Snap.first $t@4@09) this@2@09))
(pop) ; 2
; Joined path conditions
(assert (length%precondition ($Snap.first $t@4@09) this@2@09))
(assert (< 0 (length ($Snap.first $t@4@09) this@2@09)))
...
(set-option :timeout 0)
(push) ; 2
(declare-const $t@5@09 $Snap)
(assert (= $t@5@09 ($Snap.combine ($Snap.first $t@5@09) ($Snap.second $t@5@09))))
(assert (=
  ($Snap.second $t@5@09)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@5@09))
    ($Snap.second ($Snap.second $t@5@09)))))
(assert (= ($Snap.first ($Snap.second $t@5@09)) $Snap.unit))
; [eval] res == old(content(this)[0])
; [eval] old(content(this)[0])
; [eval] content(this)[0]
; [eval] content(this)
(push) ; 3
(assert (content%precondition ($Snap.first $t@4@09) this@2@09))
(pop) ; 3
; Joined path conditions
(assert (content%precondition ($Snap.first $t@4@09) this@2@09))
(push) ; 3
(assert (not (< 0 (Seq_length (content ($Snap.first $t@4@09) this@2@09)))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (= res@3@09 (Seq_index (content ($Snap.first $t@4@09) this@2@09) 0)))
(assert (= ($Snap.second ($Snap.second $t@5@09)) $Snap.unit))
; [eval] content(this) == old(content(this)[1..])
; [eval] content(this)
(push) ; 3
(assert (content%precondition ($Snap.first $t@5@09) this@2@09))
(pop) ; 3
; Joined path conditions
(assert (content%precondition ($Snap.first $t@5@09) this@2@09))
...
; Joined path conditions
(assert (Seq_equal
  (content ($Snap.first $t@5@09) this@2@09)
  (Seq_drop (content ($Snap.first $t@4@09) this@2@09) 1)))
(pop) ; 2
(push) ; 2
; [exec]
...
(assert (=
  ($Snap.first $t@4@09)
  ($Snap.combine
    ($Snap.first ($Snap.first $t@4@09))
    ($Snap.second ($Snap.first $t@4@09)))))
(assert (not (= this@2@09 $Ref.null)))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (List%trigger ($Snap.first $t@4@09) this@2@09))
; [exec]
...
(assert (not (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@4@09))) $Ref.null)))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(set-option :timeout 10)
(assert (not (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@4@09))) $Ref.null))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | First:(First:($t@4@09)) != Null | live]
; [else-branch: 0 | First:(First:($t@4@09)) == Null | dead]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | First:(First:($t@4@09)) != Null]
(assert (not
  (= ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@4@09))) $Ref.null)))
(assert (=
  ($Snap.second ($Snap.first $t@4@09))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first $t@4@09)))
    ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.first $t@4@09)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
  $Snap.unit))
; [eval] (unfolding acc(lseg(this.next, end), write) in this.next != end ==> this.data <= this.next.data)
(push) ; 4
(assert (lseg%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09))))) $Ref.null))
; [eval] this != end
(push) ; 5
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
  $Ref.null)))
(check-sat)
; unknown
(pop) ; 5
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 1 | First:(Second:(Second:(First:($t@4@09)))) != Null | live]
; [else-branch: 1 | First:(Second:(Second:(First:($t@4@09)))) == Null | live]
(set-option :timeout 0)
(push) ; 5
; [then-branch: 1 | First:(Second:(Second:(First:($t@4@09)))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
    $Ref.null)))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))
(push) ; 6
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@4@09)))
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
(check-sat)
; unknown
(pop) ; 6
...
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))
    ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))
(set-option :timeout 0)
(push) ; 6
(set-option :timeout 10)
(assert (not (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
  $Snap.unit))
; [eval] (unfolding acc(lseg(this.next, end), write) in this.next != end ==> this.data <= this.next.data)
(set-option :timeout 0)
(push) ; 6
(assert (lseg%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) $Ref.null))
; [eval] this != end
(push) ; 7
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
  $Ref.null)))
(check-sat)
; unknown
(pop) ; 7
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) != Null | live]
; [else-branch: 2 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) == Null | live]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 2 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) != Null]
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
    $Ref.null)))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))))
(push) ; 8
(set-option :timeout 10)
(assert (not (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
...
(assert (=
  ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))
    ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))))))
(set-option :timeout 0)
(push) ; 8
(set-option :timeout 10)
(assert (not (=
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))))
  $Snap.unit))
; [eval] (unfolding acc(lseg(this.next, end), write) in this.next != end ==> this.data <= this.next.data)
(declare-const recunf@6@09 Bool)
(assert (as recunf@6@09  Bool))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) != Null | live]
; [else-branch: 3 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) == Null | dead]
(set-option :timeout 0)
(push) ; 9
; [then-branch: 3 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) != Null]
...
(pop) ; 7
(push) ; 7
; [else-branch: 2 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
  $Ref.null))
(assert (=
...
; [eval] this.next != end
(push) ; 8
; [then-branch: 4 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) != Null | dead]
; [else-branch: 4 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) == Null | live]
(push) ; 9
; [else-branch: 4 | First:(Second:(First:(Second:(Second:(Second:(First:($t@4@09))))))) == Null]
(pop) ; 9
(pop) ; 8
; Joined path conditions
(pop) ; 7
(pop) ; 6
(declare-const joined_unfolding@7@09 Bool)
(assert (=>
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
    ...
    (=>
      (not
        (=
          ...
          $Ref.null))
      (<=
        ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))
        ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))))))))))
(assert (=>
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
    $Ref.null)
  (= (as joined_unfolding@7@09  Bool) true)))
; Joined path conditions
(assert (lseg%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) $Ref.null))
(assert (=>
  (not
...
(assert (or
  ...
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
      $Ref.null))))
(assert (as joined_unfolding@7@09  Bool))
; [eval] this.next != end ==> this.data <= this.next.data
; [eval] this.next != end
(push) ; 6
(push) ; 7
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | First:(Second:(Second:(First:($t@4@09)))) != Null | live]
; [else-branch: 5 | First:(Second:(Second:(First:($t@4@09)))) == Null | dead]
(set-option :timeout 0)
(push) ; 7
; [then-branch: 5 | First:(Second:(Second:(First:($t@4@09)))) != Null]
; [eval] this.data <= this.next.data
(pop) ; 7
(pop) ; 6
; Joined path conditions
(pop) ; 5
(push) ; 5
; [else-branch: 1 | First:(Second:(Second:(First:($t@4@09)))) == Null]
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
  $Ref.null))
(assert (=
...
; [eval] this.next != end
(push) ; 6
; [then-branch: 6 | First:(Second:(Second:(First:($t@4@09)))) != Null | dead]
; [else-branch: 6 | First:(Second:(Second:(First:($t@4@09)))) == Null | live]
(push) ; 7
; [else-branch: 6 | First:(Second:(Second:(First:($t@4@09)))) == Null]
(pop) ; 7
(pop) ; 6
; Joined path conditions
(pop) ; 5
(pop) ; 4
(declare-const joined_unfolding@8@09 Bool)
(assert (=>
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
    ...
    (=>
      (not
        (=
          ...
          $Ref.null))
      (<=
        ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.first $t@4@09))))
        ($SortWrappers.$SnapToInt ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))))))
(assert (=>
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
    $Ref.null)
  (= (as joined_unfolding@8@09  Bool) true)))
; Joined path conditions
(assert (lseg%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09))))) $Ref.null))
(assert (=>
  (not
  ...
  (and
    ...
    (=>
      (=
        ...
        $Ref.null)
      (= (as joined_unfolding@7@09  Bool) true))
    (lseg%trigger ($Snap.first ($Snap.second ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))) $Ref.null)
    (=>
      (not
        (=
          ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09))))))))
...
(assert (or
  ...
  (not
    (=
      ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))
      $Ref.null))))
(assert (as joined_unfolding@8@09  Bool))
; State saturation: after unfold
(set-option :timeout 40)
(check-sat)
; unknown
(assert (lseg%trigger ($Snap.second ($Snap.first $t@4@09)) ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.first $t@4@09))) $Ref.null))
; [exec]
; res := this.head.data
(declare-const res@9@09 Int)
(assert (=
  res@9@09
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.first $t@4@09))))))
; [exec]
; this.head := this.head.next
(declare-const head@10@09 $Ref)
(assert (=
  head@10@09
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))))
; [exec]
...
(assert (List%trigger ($Snap.combine
  ($SortWrappers.$RefTo$Snap head@10@09)
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.first $t@4@09)))))) this@2@09))
; [eval] res == old(content(this)[0])
; [eval] old(content(this)[0])
; [eval] content(this)[0]
; [eval] content(this)
...
; (get-info :all-statistics)
(push) ; 4
(assert (not (= res@9@09 (Seq_index (content ($Snap.first $t@4@09) this@2@09) 0))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (= res@9@09 (Seq_index (content ($Snap.first $t@4@09) this@2@09) 0)))
; [eval] content(this) == old(content(this)[1..])
; [eval] content(this)
(push) ; 4
