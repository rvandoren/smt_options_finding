...
; [eval] content(this)
(push) ; 3
(assert (content%precondition ($Snap.first $t@2@12) this@1@12))
(pop) ; 3
; Joined path conditions
(assert (content%precondition ($Snap.first $t@2@12) this@1@12))
; [eval] Seq[Int]()
(assert (Seq_equal (content ($Snap.first $t@2@12) this@1@12) (as Seq_empty  Seq<Int>)))
(pop) ; 2
(push) ; 2
; [exec]
; this := new(data, next, head, held, changed)
(declare-const this@3@12 $Ref)
(assert (not (= this@3@12 $Ref.null)))
(declare-const data@4@12 Int)
(declare-const next@5@12 $Ref)
(declare-const head@6@12 $Ref)
(declare-const held@7@12 Int)
(declare-const changed@8@12 Bool)
(assert (not (= this@3@12 this@1@12)))
; [exec]
; this.head := null
; [exec]
...
(assert (List%trigger ($Snap.combine ($SortWrappers.$RefTo$Snap $Ref.null) $Snap.unit) this@3@12))
; [eval] content(this) == Seq[Int]()
; [eval] content(this)
(push) ; 4
...
(assert (not (Seq_equal
  (content ($Snap.combine ($SortWrappers.$RefTo$Snap $Ref.null) $Snap.unit) this@3@12)
  (as Seq_empty  Seq<Int>))))
(check-sat)
; unsat
(pop) ; 4
