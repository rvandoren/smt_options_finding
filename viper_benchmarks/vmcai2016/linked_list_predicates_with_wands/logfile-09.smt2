...
; ------------------------------------------------------------
; ---------- test ----------
(declare-const lock@0@09 $Ref)
(declare-const lock@1@09 $Ref)
...
(assert (= $t@2@09 $Snap.unit))
(pop) ; 2
(push) ; 2
; [exec]
; inhale acc(List(lock), write) &&
;   (acc(lock.held, write) && acc(lock.changed, write))
(declare-const $t@3@09 $Snap)
(assert (= $t@3@09 ($Snap.combine ($Snap.first $t@3@09) ($Snap.second $t@3@09))))
(assert (=
  ($Snap.second $t@3@09)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@3@09))
    ($Snap.second ($Snap.second $t@3@09)))))
(assert (not (= lock@1@09 $Ref.null)))
...
(set-option :timeout 0)
(push) ; 3
(assert (length%precondition ($Snap.first $t@3@09) lock@1@09))
(pop) ; 3
; Joined path conditions
(assert (length%precondition ($Snap.first $t@3@09) lock@1@09))
(push) ; 3
(set-option :timeout 10)
(assert (not (not (<= 2 (length ($Snap.first $t@3@09) lock@1@09)))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
...
(push) ; 3
(set-option :timeout 10)
(assert (not (<= 2 (length ($Snap.first $t@3@09) lock@1@09))))
(check-sat)
; unknown
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | 2 <= length(First:($t@3@09), lock@1@09) | live]
; [else-branch: 0 | !(2 <= length(First:($t@3@09), lock@1@09)) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 0 | 2 <= length(First:($t@3@09), lock@1@09)]
(assert (<= 2 (length ($Snap.first $t@3@09) lock@1@09)))
; [exec]
; var r1: Int
(declare-const r1@4@09 Int)
; [exec]
; r1 := dequeue(lock)
; [eval] 0 < length(this)
; [eval] length(this)
...
; Joined path conditions
(push) ; 4
(assert (not (< 0 (length ($Snap.first $t@3@09) lock@1@09))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (< 0 (length ($Snap.first $t@3@09) lock@1@09)))
(declare-const res@5@09 Int)
(declare-const $t@6@09 $Snap)
(assert (= $t@6@09 ($Snap.combine ($Snap.first $t@6@09) ($Snap.second $t@6@09))))
(assert (=
  ($Snap.second $t@6@09)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@6@09))
    ($Snap.second ($Snap.second $t@6@09)))))
(assert (= ($Snap.first ($Snap.second $t@6@09)) $Snap.unit))
; [eval] res == old(content(this)[0])
; [eval] old(content(this)[0])
; [eval] content(this)[0]
; [eval] content(this)
(push) ; 4
(assert (content%precondition ($Snap.first $t@3@09) lock@1@09))
(pop) ; 4
; Joined path conditions
(assert (content%precondition ($Snap.first $t@3@09) lock@1@09))
(push) ; 4
(assert (not (< 0 (Seq_length (content ($Snap.first $t@3@09) lock@1@09)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (= res@5@09 (Seq_index (content ($Snap.first $t@3@09) lock@1@09) 0)))
(assert (= ($Snap.second ($Snap.second $t@6@09)) $Snap.unit))
; [eval] content(this) == old(content(this)[1..])
; [eval] content(this)
(push) ; 4
(assert (content%precondition ($Snap.first $t@6@09) lock@1@09))
(pop) ; 4
; Joined path conditions
(assert (content%precondition ($Snap.first $t@6@09) lock@1@09))
...
; Joined path conditions
(assert (Seq_equal
  (content ($Snap.first $t@6@09) lock@1@09)
  (Seq_drop (content ($Snap.first $t@3@09) lock@1@09) 1)))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
...
; [eval] length(this)
(push) ; 5
(assert (length%precondition ($Snap.first $t@6@09) lock@1@09))
(pop) ; 5
; Joined path conditions
(assert (length%precondition ($Snap.first $t@6@09) lock@1@09))
(push) ; 5
(assert (not (< 0 (length ($Snap.first $t@6@09) lock@1@09))))
(check-sat)
; unsat
(pop) ; 5
; 0.00s
; (get-info :all-statistics)
(assert (< 0 (length ($Snap.first $t@6@09) lock@1@09)))
(assert (peek%precondition ($Snap.combine ($Snap.first $t@6@09) $Snap.unit) lock@1@09))
(pop) ; 4
; Joined path conditions
(assert (and
  (length%precondition ($Snap.first $t@6@09) lock@1@09)
  (< 0 (length ($Snap.first $t@6@09) lock@1@09))
  (peek%precondition ($Snap.combine ($Snap.first $t@6@09) $Snap.unit) lock@1@09)))
(push) ; 4
(assert (not (<= res@5@09 (peek ($Snap.combine ($Snap.first $t@6@09) $Snap.unit) lock@1@09))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (<= res@5@09 (peek ($Snap.combine ($Snap.first $t@6@09) $Snap.unit) lock@1@09)))
; [exec]
; lock.changed := true
; [exec]
...
; Joined path conditions
(push) ; 4
; [then-branch: 1 | content(First:($t@3@09), lock@1@09) === content(First:($t@6@09), lock@1@09) | live]
; [else-branch: 1 | !(content(First:($t@3@09), lock@1@09) === content(First:($t@6@09), lock@1@09)) | live]
(push) ; 5
; [then-branch: 1 | content(First:($t@3@09), lock@1@09) === content(First:($t@6@09), lock@1@09)]
(assert (Seq_equal
  (content ($Snap.first $t@3@09) lock@1@09)
  (content ($Snap.first $t@6@09) lock@1@09)))
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(content(First:($t@3@09), lock@1@09) === content(First:($t@6@09), lock@1@09))]
(assert (not
  (Seq_equal
    (content ($Snap.first $t@3@09) lock@1@09)
    (content ($Snap.first $t@6@09) lock@1@09))))
...
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(2 <= length(First:($t@3@09), lock@1@09))]
(assert (not (<= 2 (length ($Snap.first $t@3@09) lock@1@09))))
(pop) ; 3
; [eval] !(2 <= length(lock))
; [eval] 2 <= length(lock)
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 2 | !(2 <= length(First:($t@3@09), lock@1@09)) | live]
; [else-branch: 2 | 2 <= length(First:($t@3@09), lock@1@09) | live]
(set-option :timeout 0)
(push) ; 3
; [then-branch: 2 | !(2 <= length(First:($t@3@09), lock@1@09))]
(assert (not (<= 2 (length ($Snap.first $t@3@09) lock@1@09))))
; [exec]
; exhale acc(List(lock), write) &&
;   (acc(lock.held, write) &&
...
(pop) ; 3
(push) ; 3
; [else-branch: 2 | 2 <= length(First:($t@3@09), lock@1@09)]
(assert (<= 2 (length ($Snap.first $t@3@09) lock@1@09)))
(pop) ; 3
(pop) ; 2
(pop) ; 1
