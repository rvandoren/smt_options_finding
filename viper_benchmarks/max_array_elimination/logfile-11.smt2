...
(assert (forall ((i@8@11 Int)) (!
  ...
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/max_array/max-array-elimination.vpr@48@10@48@70-aux|)))
(assert (forall ((i@8@11 Int)) (!
  (=>
    (and (<= 0 i@8@11) (< i@8@11 (len<Int> a@0@11)))
    (= ($FVF.lookup_val $t@4@11 (loc<Ref> a@0@11 i@8@11)) i@8@11))
  :pattern ((loc<Ref> a@0@11 i@8@11))
  :qid |prog./Users/raoulvandoren/Desktop/Master/Master_Semester_3/silicon/silver/src/test/resources/examples/max_array/max-array-elimination.vpr@48@10@48@70|)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
; [eval] 0 <= x
(push) ; 5
; [then-branch: 8 | !(0 <= x@14@11) | live]
; [else-branch: 8 | 0 <= x@14@11 | live]
(push) ; 6
; [then-branch: 8 | !(0 <= x@14@11)]
(assert (not (<= 0 x@14@11)))
(pop) ; 6
(push) ; 6
; [else-branch: 8 | 0 <= x@14@11]
(assert (<= 0 x@14@11))
; [eval] x < len(a)
; [eval] len(a)
(pop) ; 6
...
; Joined path conditions
; Joined path conditions
(assert (or (<= 0 x@14@11) (not (<= 0 x@14@11))))
(pop) ; 4
(pop) ; 3
; Joined path conditions
(assert (=>
  (not (= (len<Int> a@0@11) 0))
  (and (not (= (len<Int> a@0@11) 0)) (or (<= 0 x@14@11) (not (<= 0 x@14@11))))))
(assert (not (= (len<Int> a@0@11) 0)))
(assert (and (<= 0 x@14@11) (< x@14@11 (len<Int> a@0@11))))
...
(push) ; 6
(assert (not (and
  (img@18@11 (loc<Ref> a@0@11 x@14@11))
  (and
    (<= 0 (inv@17@11 (loc<Ref> a@0@11 x@14@11)))
    (< (inv@17@11 (loc<Ref> a@0@11 x@14@11)) (len<Int> a@0@11))))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(assert (forall ((j$2@20@11 Int)) (!
  (=>
    ...
    (<=
      ...
      ($FVF.lookup_val ($SortWrappers.$SnapTo$FVF<val> ($Snap.first $t@15@11)) (loc<Ref> a@0@11 x@14@11))))
  :pattern ((loc<Ref> a@0@11 j$2@20@11))
