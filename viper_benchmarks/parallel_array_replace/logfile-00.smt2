...
(declare-fun v@1@00 () Int)
(declare-fun before@2@00 () Int)
...
; [eval] before <= len(a)
; [eval] len(a)
(assert (<= before@2@00 (len<Int> a@0@00)))
(declare-const i@4@00 Int)
(push) ; 2
; [eval] 0 <= i && i < before
; [eval] 0 <= i
(push) ; 3
; [then-branch: 0 | !(0 <= i@4@00) | live]
; [else-branch: 0 | 0 <= i@4@00 | live]
(push) ; 4
; [then-branch: 0 | !(0 <= i@4@00)]
(assert (not (<= 0 i@4@00)))
(pop) ; 4
(push) ; 4
; [else-branch: 0 | 0 <= i@4@00]
(assert (<= 0 i@4@00))
; [eval] i < before
(pop) ; 4
(pop) ; 3
...
(assert (and (<= 0 i@4@00) (< i@4@00 before@2@00)))
; [eval] loc(a, i)
(pop) ; 2
...
(assert (forall ((i@4@00 Int)) (!
  (=>
    (and (<= 0 i@4@00) (< i@4@00 before@2@00))
...
(assert (not (forall ((i1@4@00 Int) (i2@4@00 Int)) (!
  (=>
    (and
      (and (<= 0 i1@4@00) (< i1@4@00 before@2@00))
      (and (<= 0 i2@4@00) (< i2@4@00 before@2@00))
      (= (loc<Ref> a@0@00 i1@4@00) (loc<Ref> a@0@00 i2@4@00)))
    (= i1@4@00 i2@4@00))
...
(assert (forall ((i@4@00 Int)) (!
  (=>
    ...
    (and
      (=
        (inv@5@00 s@$ a@0@00 v@1@00 before@2@00 (loc<Ref> a@0@00 i@4@00))
        i@4@00)
...
(assert (forall ((r $Ref)) (!
  (=>
    (and
      (img@6@00 s@$ a@0@00 v@1@00 before@2@00 r)
      (and
        (<= 0 (inv@5@00 s@$ a@0@00 v@1@00 before@2@00 r))
        (< (inv@5@00 s@$ a@0@00 v@1@00 before@2@00 r) before@2@00)))
    (= (loc<Ref> a@0@00 (inv@5@00 s@$ a@0@00 v@1@00 before@2@00 r)) r))
  :pattern ((inv@5@00 s@$ a@0@00 v@1@00 before@2@00 r))
  :qid |val-fctOfInv|)))
...
(assert (forall ((i@4@00 Int)) (!
  (=>
    (and (<= 0 i@4@00) (< i@4@00 before@2@00))
    (not (= (loc<Ref> a@0@00 i@4@00) $Ref.null)))
  :pattern ((loc<Ref> a@0@00 i@4@00))
